...
import { Tag, PlusIcon, CalendarIcon, ClockIcon } from "lucide-react-native";
...
export function Activities({ tripDetails }: Props) {
  ...
  return (
    <View className="flex-1">
      <View className="w-ful flex-row mt-5 mb-6 items-center">
          ...
          renderSectionHeader={({ section }) => (
            <View className="w-full">
              ...
              {section.data.length === 0 && (
                <Text className="text-zinc-500 text-sm font-regular mb-8">
        ...
        <View className="mt-4 mb-6">
          ...
          <View className="w-full flex-row gap-2 mt-2">
            <Input variant="secondary" className="flex-1">
              <CalendarIcon size={20} color={colors.zinc[400]} />
              <Input.Field
                placeholder="Data"
            ...
            <Input variant="secondary" className="flex-1">
              <ClockIcon size={20} color={colors.zinc[400]} />
              <Input.Field
                placeholder="Horário?"
                onChangeText={(text) =>
